...
const cardsInormation = [ //все данные из карточек
    {
        ...
        price: "500",
        nameIsLong: 0 // 0 - 1word; 0.5 - 2words; 1 - >3words.
    },
    {
...
function createCard(name, description, img, price, isLong) {
    return `
        <section class="card" id="${name}">
                    <div class="card__image-container">
                        <img class="card__image" src="${img}">
                        
                        <div class="card__title" data-name-is-long="${isLong}">
                            <b>
                                ${name}                            
                            </b>
                        </div>
...
// popup началоооооооооооооооооооооооооооооооооооооооооооооооо
